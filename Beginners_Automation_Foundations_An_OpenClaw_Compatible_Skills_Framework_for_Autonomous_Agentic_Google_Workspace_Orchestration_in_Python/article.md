...
![Cover 2](./email_reply_screenshot.png)
...
![The OpenClaw Vision: From Tools to Autonomous Actors](./2.jpg)
...
![Authentication as Foundation: OAuth 2.0 Deep Dive](./3.jpg)
...
![Create a Google Cloud Project](././onboard1.png)
...
![Enable the Gmail API](././onboard2.png)
![Enable the Gmail API](././onboard3.png)
...
![Configure the OAuth Consent Screen](././onboard4.png)
![Configure the OAuth Consent Screen](././onboard5.png)
...
![Configure the OAuth Consent Screen](././onboard6.png)
![Configure the OAuth Consent Screen](././onboard7.png)
...
![Configure the OAuth Consent Screen](././onboard8.png)
...
![Agent prompt instructing it to search for an email and book an event](./prompt1_booking.png)
...
![Agent finalizing the booking process](./prompt2_booking.png)
...
![Calendar event successfully created](./calendar.png)
...
![Confirmation email received](./calendar_email_confirmation.png)

*Attendees receive an email notification from Google Calendar with the event details and RSVP options.*

![Agent notification email sent](./agent_email_notification.png)
...
![Google API Usage](././google_api_usage.png)
